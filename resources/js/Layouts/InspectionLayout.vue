...
<template>
    <div class="h-screen overflow-hidden bg-surface-50 flex flex-col md:flex-row">
        
        <!-- Left Sidebar: Progress and Navigation -->
        <aside class="w-full md:w-64 lg:w-72 bg-white border-r border-surface-200 flex flex-col shrink-0 md:h-full">
        ...
        <main class="flex-grow flex flex-col min-w-0 md:h-full">
        ...
        <aside class="w-full md:w-64 lg:w-72 bg-white border-l border-surface-200 shrink-0 flex flex-col md:h-full">
